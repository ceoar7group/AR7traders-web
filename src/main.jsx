...
const cars = [ {id:1, make:'Rolls-Royce', model:'Ghost', year:2023, km:'4,200', fuel:'Petrol', body:'Luxury', price:'$189,000', image:'/assets/lux/rolls-royce-ghost.jpg', grade:'5.0', status:'In Stock', location:'Yokohama', tr:'AT', drv:'AWD', eng:'6,750cc', seats:5, col:'Two-tone', st:'RHD'},
 ...
 {id:13, make:'Toyota', model:'Land Cruiser ZX', year:2022, km:'18,400', fuel:'Petrol', body:'SUV', price:'$58,900', image:'/assets/used-japanese-cars-auction-export-toyota-3.jpg', grade:'4.5', status:'In Stock', location:'Yokohama', tr:'AT', drv:'4WD', eng:'3,500cc', seats:7, col:'White', st:'RHD'},
 {id:14, make:'Toyota', model:'Alphard S C Package', year:2021, km:'32,100', fuel:'Hybrid', body:'MPV', price:'$36,800', image:'/assets/used-japanese-cars-auction-export-toyota-2.jpg', grade:'4.5', status:'Auction', location:'USS Tokyo', tr:'AT', drv:'2WD', eng:'2,500cc', seats:7, col:'Black', st:'RHD'},
 {id:15, make:'Toyota', model:'Vellfire ZG Edition', year:2020, km:'41,700', fuel:'Petrol', body:'MPV', price:'$29,600', image:'/assets/used-japanese-cars-auction-export-toyota-4.jpg', grade:'4.0', status:'In Stock', location:'Nagoya', tr:'AT', drv:'2WD', eng:'2,500cc', seats:7, col:'Pearl White', st:'RHD'},
 {id:16, make:'Toyota', model:'Noah S-Z', year:2026, km:'110', fuel:'Hybrid', body:'MPV', price:'$32,400', image:'/assets/used-japanese-cars-auction-export-toyota-1.jpg', grade:'S', status:'New Arrival', location:'Kobe', tr:'CVT', drv:'2WD', eng:'1,800cc', seats:7, col:'White', st:'RHD'},
 {id:17, make:'Nissan', model:'Note e-Power X', year:2023, km:'12,800', fuel:'Hybrid', body:'Hatchback', price:'$14,900', image:'/assets/used-japanese-cars-auction-export-toyota-5.jpg', grade:'5.0', status:'Auction', location:'CAA Chubu', tr:'AT', drv:'2WD', eng:'1,200cc', seats:5, col:'Silver', st:'RHD'},
 {id:18, make:'Toyota', model:'Land Cruiser Prado TX', year:2020, km:'48,600', fuel:'Diesel', body:'SUV', price:'$38,200', image:'/assets/japan-used-car-export-inventory-toyota-h-1.jpg', grade:'4.0', status:'In Stock', location:'Osaka', tr:'AT', drv:'4WD', eng:'2,800cc', seats:7, col:'White', st:'RHD'},
 {id:19, make:'Toyota', model:'Prado L Package', year:2017, km:'67,900', fuel:'Diesel', body:'SUV', price:'$31,500', image:'/assets/japan-used-car-export-inventory-toyota-h-2.jpg', grade:'4.0', status:'Auction', location:'JU Aichi', tr:'AT', drv:'4WD', eng:'2,800cc', seats:7, col:'Gray', st:'RHD'},
 {id:20, make:'Toyota', model:'Harrier Z Leather', year:2020, km:'29,300', fuel:'Hybrid', body:'SUV', price:'$27,800', image:'/assets/japan-used-car-export-inventory-toyota-h-3.jpg', grade:'4.5', status:'New Arrival', location:'Tokyo', tr:'CVT', drv:'2WD', eng:'2,500cc', seats:5, col:'Gray', st:'RHD'},
 {id:21, make:'Toyota', model:'Harrier Premium', year:2019, km:'36,200', fuel:'Petrol', body:'SUV', price:'$24,600', image:'/assets/japan-used-car-export-inventory-toyota-h-4.jpg', grade:'4.5', status:'In Stock', location:'Kobe', tr:'CVT', drv:'2WD', eng:'2,000cc', seats:5, col:'Pearl White', st:'RHD'},
 {id:22, make:'Lexus', model:'RX 450h F Sport', year:2021, km:'22,700', fuel:'Hybrid', body:'SUV', price:'$43,900', image:'/assets/japan-used-car-export-inventory-toyota-h-5.jpg', grade:'5.0', status:'Auction', location:'USS Tokyo', tr:'AT', drv:'4WD', eng:'3,500cc', seats:5, col:'Black', st:'RHD'},
 {id:23, make:'Nissan', model:'Serena Highway Star', year:2022, km:'24,800', fuel:'Hybrid', body:'MPV', price:'$22,800', image:'/assets/japan-used-car-export-stock-honda-vezel--1.jpg', grade:'4.5', status:'New Arrival', location:'Nagoya', tr:'CVT', drv:'2WD', eng:'2,000cc', seats:8, col:'White', st:'RHD'},
 {id:24, make:'Toyota', model:'Vitz F Safety Edition', year:2019, km:'39,100', fuel:'Petrol', body:'Hatchback', price:'$9,850', image:'/assets/japan-used-car-export-stock-honda-vezel--2.jpg', grade:'4.0', status:'In Stock', location:'Yokohama', tr:'CVT', drv:'2WD', eng:'1,300cc', seats:5, col:'Red', st:'RHD'},
 {id:25, make:'Toyota', model:'Vitz Jewela', year:2018, km:'44,300', fuel:'Petrol', body:'Hatchback', price:'$8,900', image:'/assets/japan-used-car-export-stock-honda-vezel--3.jpg', grade:'4.0', status:'Auction', location:'CAA Chubu', tr:'CVT', drv:'2WD', eng:'1,300cc', seats:5, col:'Blue', st:'RHD'},
 {id:26, make:'Honda', model:'Vezel e:HEV Z', year:2023, km:'11,600', fuel:'Hybrid', body:'SUV', price:'$25,700', image:'/assets/japan-used-car-export-stock-honda-vezel--4.jpg', grade:'5.0', status:'In Stock', location:'Kobe', tr:'CVT', drv:'2WD', eng:'1,500cc', seats:5, col:'White', st:'RHD'},
 {id:27, make:'Honda', model:'Vezel RS Sensing', year:2021, km:'26,900', fuel:'Hybrid', body:'SUV', price:'$21,400', image:'/assets/japan-used-car-export-stock-honda-vezel--5.jpg', grade:'4.5', status:'Auction', location:'USS Tokyo', tr:'CVT', drv:'2WD', eng:'1,500cc', seats:5, col:'Blue', st:'RHD'},
 {id:28, make:'Toyota', model:'Aqua S', year:2021, km:'15,800', fuel:'Hybrid', body:'Hatchback', price:'$12,400', image:'/assets/used-japanese-cars-auction-export-toyota-5.jpg', grade:'5.0', status:'In Stock', location:'Yokohama', tr:'CVT', drv:'2WD', eng:'1,500cc', seats:5, col:'Green', st:'RHD'},
 {id:29, make:'Nissan', model:'X-Trail 20X', year:2020, km:'33,500', fuel:'Hybrid', body:'SUV', price:'$18,900', image:'/assets/japan-used-car-export-stock-honda-vezel--1.jpg', grade:'4.5', status:'In Stock', location:'Nagoya', tr:'CVT', drv:'4WD', eng:'2,000cc', seats:5, col:'Silver', st:'RHD'},
 {id:30, make:'Honda', model:'Fit e:HEV NESS', year:2022, km:'9,800', fuel:'Hybrid', body:'Hatchback', price:'$13,700', image:'/assets/japan-used-car-export-stock-honda-vezel--2.jpg', grade:'5.0', status:'New Arrival', location:'Tokyo', tr:'CVT', drv:'2WD', eng:'1,500cc', seats:5, col:'Yellow', st:'RHD'},
 {id:31, make:'Suzuki', model:'Swift Sport', year:2019, km:'28,700', fuel:'Petrol', body:'Hatchback', price:'$11,900', image:'/assets/japan-used-car-export-stock-honda-vezel--3.jpg', grade:'4.0', status:'Auction', location:'JU Aichi', tr:'MT', drv:'2WD', eng:'1,400cc', seats:5, col:'Red', st:'RHD'},
 {id:32, make:'Mazda', model:'CX-5 XD L Package', year:2021, km:'21,400', fuel:'Diesel', body:'SUV', price:'$22,900', image:'/assets/japan-used-car-export-stock-honda-vezel--4.jpg', grade:'4.5', status:'In Stock', location:'Kobe', tr:'AT', drv:'4WD', eng:'2,200cc', seats:5, col:'Gray', st:'RHD'},
 {id:33, make:'Mitsubishi', model:'Outlander PHEV', year:2021, km:'19,200', fuel:'Hybrid', body:'SUV', price:'$26,900', image:'/assets/japan-used-car-export-stock-honda-vezel--5.jpg', grade:'4.5', status:'Auction', location:'USS Tokyo', tr:'AT', drv:'4WD', eng:'2,400cc', seats:5, col:'White', st:'RHD'},
 {id:34, make:'Subaru', model:'Forester X-EDITION', year:2020, km:'31,900', fuel:'Petrol', body:'SUV', price:'$17,900', image:'/assets/japan-used-car-export-inventory-toyota-h-1.jpg', grade:'4.5', status:'In Stock', location:'Osaka', tr:'CVT', drv:'4WD', eng:'2,000cc', seats:5, col:'Blue', st:'RHD'},
 {id:35, make:'Daihatsu', model:'Move Canbus X', year:2021, km:'12,400', fuel:'Petrol', body:'Kei', price:'$7,200', image:'/assets/japan-used-car-export-stock-honda-vezel--2.jpg', grade:'5.0', status:'New Arrival', location:'Kobe', tr:'CVT', drv:'2WD', eng:'660cc', seats:4, col:'Pink', st:'RHD'},
 {id:36, make:'Toyota', model:'Hiace Van 2.7 DX', year:2019, km:'52,300', fuel:'Petrol', body:'Van', price:'$18,900', image:'/assets/japan-used-car-export-inventory-toyota-h-3.jpg', grade:'4.0', status:'In Stock', location:'Yokohama', tr:'AT', drv:'2WD', eng:'2,700cc', seats:3, col:'White', st:'RHD'},
 {id:37, make:'Honda', model:'Stepwgn Air EX', year:2021, km:'24,700', fuel:'Hybrid', body:'MPV', price:'$25,900', image:'/assets/used-japanese-cars-auction-export-toyota-1.jpg', grade:'4.5', status:'Auction', location:'CAA Chubu', tr:'CVT', drv:'2WD', eng:'2,000cc', seats:8, col:'White', st:'RHD'},
 {id:38, make:'Mercedes-Benz', model:'C200 Avantgarde', year:2019, km:'36,100', fuel:'Petrol', body:'Sedan', price:'$26,200', image:'/assets/japan-used-car-export-inventory-toyota-h-4.jpg', grade:'4.5', status:'In Stock', location:'Tokyo', tr:'AT', drv:'2WD', eng:'1,500cc', seats:5, col:'Black', st:'LHD'},
 {id:39, make:'BMW', model:'320i M Sport', year:2018, km:'41,800', fuel:'Petrol', body:'Sedan', price:'$19,800', image:'/assets/japan-used-car-export-inventory-toyota-h-5.jpg', grade:'4.0', status:'Auction', location:'USS Tokyo', tr:'AT', drv:'2WD', eng:'2,000cc', seats:5, col:'Blue', st:'LHD'},
 {id:40, make:'Audi', model:'A4 2.0 TFSI S line', year:2019, km:'33,200', fuel:'Petrol', body:'Sedan', price:'$21,800', image:'/assets/japan-used-car-export-inventory-toyota-h-2.jpg', grade:'4.5', status:'In Stock', location:'Osaka', tr:'AT', drv:'4WD', eng:'2,000cc', seats:5, col:'White', st:'LHD'},
 {id:41, make:'Toyota', model:'Voxy Hybrid ZS', year:2021, km:'21,900', fuel:'Hybrid', body:'MPV', price:'$24,400', image:'/assets/used-japanese-cars-auction-export-toyota-4.jpg', grade:'4.5', status:'New Arrival', location:'Nagoya', tr:'CVT', drv:'2WD', eng:'1,800cc', seats:7, col:'White', st:'RHD'},
 {id:42, make:'Nissan', model:'Juke 15RX', year:2020, km:'26,800', fuel:'Petrol', body:'SUV', price:'$12,900', image:'/assets/japan-used-car-export-stock-honda-vezel--5.jpg', grade:'4.5', status:'In Stock', location:'Yokohama', tr:'CVT', drv:'2WD', eng:'1,500cc', seats:5, col:'Silver', st:'RHD'}
];
...
const priceOf=c=>Number(c.price.replace(/[$,]/g,''));
const stockNo=c=>'AR7-'+(26000+c.id);
...
const takePending=()=>{const m=pendingMake;pendingMake=null;return m||'All'};
...
function VehicleCard({c,onOpen,comp,onCmp}){return <article className="car-card page-car" onClick={()=>onOpen?.(c)}>
 ...
 <div className="car-info"><div className="make"><img loading="lazy" decoding="async" width="34" height="22" src={LOGO(c.make)} alt=""/>{c.make}</div><h3>{c.model}</h3><div className="specs"><span><CalendarDays/> {c.year}</span><span><Gauge/> {c.km} km</span><span><Fuel/> {c.fuel}</span><span><ArrowLeftRight/> {c.tr}</span></div><div className="car-bottom"><div><small>EXPORT PRICE FROM</small><b>{c.price}</b></div><span className={"cmp-chip "+(comp?'on':'')} onClick={e=>{e.stopPropagation();onCmp&&onCmp(c)}}><ArrowLeftRight/>{comp?'Added':'Compare'}</span><button><ArrowUpRight/></button></div><div className="loc"><MapPin/> {c.location}, Japan</div></div>
 </article>}

const rotatingCars=[cars[0],cars[2],cars[5],cars[6],cars[7],cars[8],cars[10]];
const heroAuctions=[
...
function HeroVisual({navigate}){
 ...
 useEffect(()=>{
  ...
  const start=()=>{if(carTimer)return;carTimer=setInterval(()=>setIdx(v=>(v+1)%rotatingCars.length),3200);auctionTimer=setInterval(()=>setAuctionIdx(v=>(v+1)%heroAuctions.length),5200);routeTimer=setInterval(()=>setRouteIdx(v=>(v+1)%heroRoutes.length),6200);tickTimer=setInterval(()=>setNow(Date.now()),1000)};
 ...
 return <div className="hero-visual" ref={wrap} onMouseMove={onMove} onMouseLeave={onLeave}>
  ...
  <div className="hero-card car-main" onClick={()=>navigate('inventory')} title="View rotating demo stock">
   <div className="hero-stack">{rotatingCars.map((x,n)=><img key={x.id} className={n===idx?'active':''} src={x.image} alt={`${x.make} ${x.model}`} fetchPriority={n===0?'high':'auto'} decoding="async"/>)}</div>
   <div className="image-shade"/>
   <div className="car-float-title" key={idx}>
    <span>{c.status.toUpperCase()}</span><h3>{c.make} {c.model}</h3><p>{c.year} · Grade {c.grade} · {c.price}</p>
   </div>
   <div className="car-dots">{rotatingCars.map((x,n)=><i key={x.id} className={n===idx?'active':''}/>)}</div>
   <div className="car-counter"><CarFront/> {idx+1}/{rotatingCars.length} · rotating stock</div>
  </div>
...
function ExtraPage({type,navigate,openAuction}){
 ...
 return <section className="inner-page extra-page"><div className="page-hero mini extra-head"><div className="page-orb-wrap"><InteractiveGlobe lite cls="mini" onTap={()=>navigate('world')}/></div><div className="shell"><div className="kicker">{h[0]}</div><h1>{h[1]}</h1><p>{h[2]}</p><button className="gold-btn" onClick={type==='portal'?()=>navigate('account'):openAuction}>{type==='portal'?'Open my real account':'Talk to our team'} <ArrowRight/></button></div></div><div className="shell page-content">
 {type==='services'&&<><div className="service-layout"><div className="service-tabs">{services.map((x,i)=><button className={service===i?'active':''} onClick={()=>setService(i)}><span>0{i+1}</span>{x[0]}<ArrowRight/></button>)}</div><div className="service-panel"><Gavel/><div className="kicker">AR7 SERVICE 0{service+1}</div><h2>{services[service][0]}</h2><p>{services[service][1]}</p><strong>{services[service][2]}</strong><ul><li><Check/> Dedicated Japan-based specialist</li><li><Check/> Transparent itemized quotation</li><li><Check/> Photo and status updates</li></ul><button className="primary" onClick={openAuction}>Request this service</button></div></div><div className="demo-strip">{[['14+','Auction partners'],['24h','Average response'],['100%','Cost transparency'],['1 team','End-to-end support']].map(x=><div><b>{x[0]}</b><span>{x[1]}</span></div>)}</div></>}
 {type==='destinations'&&<><div className="destination-picker"><div><div className="kicker">DEMO ROUTE CALCULATOR</div><h2>Where are we shipping?</h2></div><select value={port} onChange={e=>setPort(e.target.value)}>{destinations.map(x=><option>{FLAG[x[0]]} {x[1].split(' / ')[0]}</option>)}</select><button className="primary" onClick={openAuction}>Get shipping quote</button></div><div className="destination-grid">{destinations.map(x=><article><Globe2/><div className="kicker">{FLAG[x[0]]} {x[0]}</div><h3>{x[1]}</h3><p><Ship/> Estimated transit: <b>{x[2]}</b></p><small>POPULAR: {x[3]}</small><button onClick={openAuction}>View market guide <ArrowRight/></button></article>)}</div></>}
 {type==='reviews'&&<><div className="review-summary"><div><b>4.9</b><span>★★★★★</span><small>Demo customer rating</small></div><p>“Communication was excellent from the auction sheet to vessel arrival. Every cost was explained before we bid.”</p></div><div className="review-grid">{[['AH','Ahmed H.','Pakistan','Toyota Prado','My agent checked three cars and told me not to bid on two. That honesty earned my trust.'],['MK','Mary K.','Kenya','Toyota Harrier','Photos, documents and shipping updates were all inside the portal. Very straightforward.'],['DO','Daniel O.','United Kingdom','Toyota Vellfire','The translated sheet and live advice made my first Japanese auction purchase easy.'],['SA','Saeed A.','UAE','Lexus RX450h','AR7 found the exact color and grade within nine days and handled the full export.'],['JM','James M.','New Zealand','Clear landed estimate, clean car and delivery within the expected vessel window.'],['FK','Fatima K.','Tanzania','The team answered every question and shared inspection videos before shipment.']].map(x=><article><div><i>{x[0]}</i><span><b>{x[1]}</b><small>{FLAG[x[2]]||''} {x[2]} · {x[3]}</small></span></div><strong>★★★★★</strong><p>“{x[4]}”</p><BadgeCheck/></article>)}</div></>}
 {type==='faq'&&<div className="faq-layout"><div><div className="kicker">POPULAR QUESTIONS</div><h2>Buying from Japan, explained.</h2><p>Click each question to explore the demo support content.</p><button className="primary" onClick={()=>navigate('contact')}>Ask another question</button></div><div className="accordions">{questions.map((x,i)=><article className={open===i?'open':''}><button onClick={()=>setOpen(open===i?-1:i)}><span>{x[0]}</span><b>{open===i?'−':'+'}</b></button>{open===i&&<p>{x[1]}</p>}</article>)}</div></div>}
 {type==='portal'&&<div className="portal-live-note"><ShieldCheck/><div><b>This is a preview of the dashboard.</b><span>Your own vehicles, every payment received and the balance remaining are waiting in your account.</span></div><button onClick={()=>navigate('account')}>Sign in <ArrowRight/></button></div>}
 {type==='portal'&&<div className="portal-demo"><aside><img src="/assets/ar7-mark.png" alt="AR7 Traders"/>{['Shipments','Auctions','Documents','Payments'].map(x=><button className={portalTab===x?'active':''} onClick={()=>setPortalTab(x)}>{x}</button>)}<small>DEMO ACCOUNT<br/><b>Imran Khan</b></small></aside><main><header><div><small>CLIENT PORTAL / {portalTab.toUpperCase()}</small><h2>{portalTab}</h2></div><button onClick={openAuction}>Contact agent</button></header>{portalTab==='Shipments'?<div className="portal-shipment"><div className="portal-car"><img loading="lazy" decoding="async" src={cars[0].image} alt={`${cars[0].make} ${cars[0].model} for export from Japan`}/><span><small>AR7-260184</small><b>Toyota Land Cruiser ZX</b><em>Yokohama → Karachi</em></span><strong>IN TRANSIT</strong></div><div className="track-line">{['Purchased','Inspected','Loaded','At sea','Arrived'].map((x,i)=><span className={i<4?'done':''}><i/>{x}<small>{i<4?'Complete':'Sep 08'}</small></span>)}</div></div>:portalTab==='Auctions'?<div className="portal-list">{cars.slice(1,5).map(c=><VehicleCard c={c}/>)}</div>:portalTab==='Documents'?<div className="doc-list">{['Commercial invoice.pdf','Export certificate.pdf','Bill of lading.pdf','Inspection report.pdf'].map((x,i)=><button onClick={openAuction}><ClipboardCheck/><span><b>{x}</b><small>Updated Aug {12+i}, 2026 · PDF</small></span><ArrowUpRight/></button>)}</div>:<div className="payment-card"><BadgeCheck/><h3>Account up to date</h3><p>All demo invoices have been paid.</p><div><span>Vehicle payment<b>$58,900</b></span><span>Freight & insurance<b>$2,480</b></span><span>Balance due<b>$0</b></span></div></div>}</main></div>}
 </div></section>
}
...
function ExtraPages2({type,navigate,openAuction}){
 ...
 {type==='brands'&&<><div className="brand-grid">{BRANDS().map(b=><article className="brand-card" key={b.name}><span className="brand-tile"><img loading="lazy" decoding="async" width="56" height="34" src={LOGO(b.name)} alt={b.name+" logo"}/><small>{b.name}</small></span><div className="brand-body"><div><b>{b.count} vehicles</b><span>in demo stock</span></div><div className="brand-models">{b.models.map(m=><button onClick={()=>{pendingMake=b.name;navigate('inventory')}} key={m}>{m}</button>)}</div><button className="outline-btn" onClick={()=>{pendingMake=b.name;navigate('inventory')}}>View {b.name} stock <ArrowRight/></button></div></article>)}</div><div className="demo-strip">{BRANDS().length===0?null:[['12','Brands catalogued'],['30','Demo vehicles'],['100%','Auction-sourced'],['24h','New stock update']].map(x=><div key={x[0]}><b>{x[0]}</b><span>{x[1]}</span></div>)}</div></>}
 ...
 {type==='tools'&&<div className="tools-grid"><article className="tool-card"><BookOpen/><div className="kicker">DEMO CIF CALCULATOR</div><h3>Shipping cost to your port</h3><label>DESTINATION PORT<select value={shipDest} onChange={e=>setShipDest(e.target.value)}>{DEST.map(x=><option key={x[1]}>{x[1]}</option>)}</select></label><label>VEHICLE VALUE (FOB USD)<input type="number" value={shipPrice} onChange={e=>setShipPrice(Math.max(500,+e.target.value||0))}/></label><label>SHIPPING METHOD<select value={shipMethod} onChange={e=>setShipMethod(e.target.value)}><option>RoRo</option><option>Container (+$2,000)</option></select></label><div className="calc-out"><span><small>FREIGHT</small><b>{money(Math.round(shipPrice*0.016+(DEST.find(x=>x[1]===shipDest)||DEST[0])[4]+(shipMethod==='Container (+$2,000)'?2000:0)))}</b></span><span><small>DOCS & INSURANCE</small><b>{money(350+Math.round(shipPrice*0.016))}</b></span><span className="total"><small>EST. CIF TOTAL</small><b>{money(shipPrice+Math.round(shipPrice*0.016+(DEST.find(x=>x[1]===shipDest)||DEST[0])[4]+(shipMethod==='Container (+$2,000)'?2000:0))+350+Math.round(shipPrice*0.016))}</b></span></div><small className="demo-note"><LockKeyhole/> Demo estimate — final quote issued by our export desk.</small></article><article className="tool-card"><Calculator/><div className="kicker">DEMO DUTY CALCULATOR</div><h3>Import duty & taxes</h3><label>DESTINATION COUNTRY<select value={dutyCountry} onChange={e=>setDutyCountry(e.target.value)}>{Object.keys(DUTY).map(x=><option key={x}>{FLAG[x]} {x}</option>)}</select></label><label>VEHICLE VALUE (USD)<input type="number" value={dutyPrice} onChange={e=>setDutyPrice(Math.max(500,+e.target.value||0))}/></label><div className="calc-out"><span><small>EST. DUTY + TAX</small><b>{money(Math.round(dutyPrice*DUTY[dutyCountry]/100))}</b></span><span className="total"><small>LANDED ESTIMATE (CIF + DUTY)</small><b>{money(Math.round(dutyPrice+dutyPrice*DUTY[dutyCountry]/100))}</b></span></div><p className="tool-note">Percentages are demo approximations of common applied rates. Local registration fees and port charges vary — our team prepares the exact landed costing for your port.</p></article></div>}
...
function InnerPage({page,navigate,openAuction,favs,setFavs}){
 ...
 if(selected)return <section className="inner-page detail-page"><div className="shell"><button className="back-btn" onClick={()=>{setSelected(null);setGalleryImage(null)}}>← Back to inventory</button><div className="detail-grid"><div className="detail-gallery"><div className="detail-main-image"><img decoding="async" src={detailImage} alt={`${selected.make} ${selected.model} showroom view`} onClick={()=>{setZoomLevel(1);setZoomOpen(true)}}/>{detailGallery.length>1&&<><button className="gallery-arrow prev" onClick={()=>stepGallery(-1)} aria-label="Previous vehicle image"><ChevronLeft/></button><button className="gallery-arrow next" onClick={()=>stepGallery(1)} aria-label="Next vehicle image"><ChevronRight/></button><span className="gallery-count">{detailGallery.indexOf(detailImage)+1} / {detailGallery.length}</span></>}<button className="gallery-expand" onClick={()=>{setZoomLevel(1);setZoomOpen(true)}} aria-label="Enlarge vehicle image"><Maximize2/> Enlarge</button></div><div className="hero-orb in-page detail-orb"><InteractiveGlobe lite cls="mini" onTap={()=>navigate('world')}/></div><div className="detail-thumbs">{detailGallery.map((img,i)=><button className={detailImage===img?'active':''} onClick={()=>setGalleryImage(img)} key={img+i}><img loading="lazy" decoding="async" src={img} alt={(selected?selected.name+" — ":"")+"photo"}/><small>{i===0?'Main':'View '+(i+1)}</small></button>)}</div><span className="sheet-tag"><ClipboardCheck/> Auction sheet included</span>{zoomOpen&&<div className="gallery-lightbox" onClick={()=>setZoomOpen(false)}><div className="lightbox-stage" onClick={e=>e.stopPropagation()}><img src={detailImage} alt={`${selected.make} ${selected.model} enlarged`} style={{transform:`scale(${zoomLevel})`}}/><button className="lightbox-close" onClick={()=>setZoomOpen(false)} aria-label="Close enlarged image"><X/></button>{detailGallery.length>1&&<><button className="lightbox-arrow prev" onClick={()=>stepGallery(-1)} aria-label="Previous image"><ChevronLeft/></button><button className="lightbox-arrow next" onClick={()=>stepGallery(1)} aria-label="Next image"><ChevronRight/></button></>}<div className="zoom-controls"><button onClick={()=>setZoomLevel(v=>Math.max(1,v-.25))}><ZoomOut/> Zoom out</button><b>{Math.round(zoomLevel*100)}%</b><button onClick={()=>setZoomLevel(v=>Math.min(2.5,v+.25))}><ZoomIn/> Zoom in</button></div></div></div>}</div><div className="detail-info"><div className="kicker">VERIFIED JAPAN STOCK · <b style={{color:'var(--gold)'}}>{stockNo(selected)}</b></div><h1>{selected.make}<br/><em>{selected.model}</em></h1><div className="detail-price"><small>EXPORT PRICE (FOB)</small><b>{selected.price}</b></div><div className="detail-specs"><span><CalendarDays/><b>{selected.year}</b><small>Year</small></span><span><Gauge/><b>{selected.km} km</b><small>Mileage</small></span><span><Fuel/><b>{selected.fuel}</b><small>Fuel</small></span><span><ArrowLeftRight/><b>{selected.tr}</b><small>Transmission</small></span><span><BadgeCheck/><b>{selected.grade}</b><small>Grade</small></span><span><Ship/><b>{selected.st}</b><small>Steering</small></span></div><div className="spec-table"><h4>Full specifications</h4>{[['Body type',selected.body],['Engine',selected.eng],['Transmission',selected.tr],['Drive',selected.drv],['Doors',selected.doors],['Seats',selected.seats],['Chassis no.',selected.chassis],['Colour',selected.col],['Interior',selected.int],['Fuel',selected.fuel],['Steering',selected.st],['Auction venue',selected.ven],['Location',selected.location+', Japan'],['Available',selected.arr],['Stock no.',stockNo(selected)],['Status',selected.status]].map(x=><span key={x[0]}><small>{x[0]}</small><b>{x[1]}</b></span>)}</div><div className="feat-box"><h4>Equipment & features</h4><div className="feat-chips">{selected.feats.map(f=><span key={f}><Check/> {f}</span>)}</div></div><div className="cif-box"><div className="kicker">DEMO CIF ESTIMATE</div><select value={destSel} onChange={e=>setDestSel(e.target.value)}>{DEST.map(x=><option key={x[1]}>{x[1]}</option>)}</select>{(()=>{const e=estimateFor(selected,destSel);return <div className="cif-rows"><span><small>FREIGHT (RoRo)</small><b>{money(e.freight)}</b></span><span><small>DOCS</small><b>{money(e.docs)}</b></span><span><small>INSURANCE 1.6%</small><b>{money(e.ins)}</b></span><span className="total"><small>CIF · ETA ±{e.days} DAYS</small><b>{money(e.cif)}</b></span></div>})()}</div><div className="brand-brandlogo"><img loading="lazy" decoding="async" src={LOGO(selected.make)} alt={selected.make+" logo"}/><span>{selected.make} · official AR7 partner network</span></div><div className="detail-actions"><button className="primary" onClick={openAuction}>Enquire now <ArrowRight/></button><button className={favs.includes(selected.id)?'ghost-btn fav-on':'ghost-btn'} onClick={()=>setFavs(v=>v.includes(selected.id)?v.filter(x=>x!==selected.id):[...v,selected.id])}><Heart fill={favs.includes(selected.id)?'currentColor':'none'}/> {favs.includes(selected.id)?'Saved':'Save'}</button></div><div className="sheet-box"><ClipboardCheck/><div><b>Auction sheet verified</b><p>Original inspection report translated by our Japan team — grades, marks and repair history in plain English.</p></div></div></div></div></div></section>;
if(['services','destinations','reviews','faq','portal'].includes(page))return <ExtraPage type={page} navigate={navigate} openAuction={openAuction}/>;
 ...
 const isShowroom=c=>c.id<=12;
 const list=cars.filter(c=>(c.make+' '+c.model+' '+c.location).toLowerCase().includes(query.toLowerCase())&&(body==='All'||(body==='Showroom'&&isShowroom(c))||(body==='Japan Stock'&&!isShowroom(c))||c.body===body)&&(make==='All'||c.make===make)&&(fuel==='All'||c.fuel===fuel)&&(priceF==='Any'||(priceF==='Under $15k'&&priceOf(c)<15000)||(priceF==='$15k–$30k'&&priceOf(c)>=15000&&priceOf(c)<30000)||(priceF==='$30k+'&&priceOf(c)>=30000))).sort((a,b)=>{const p=x=>priceOf(x);switch(sortF){case 'Price: low to high':return p(a)-p(b);case 'Price: high to low':return p(b)-p(a);case 'Mileage: low to high':return Number(a.km.replace(/,/g,''))-Number(b.km.replace(/,/g,''));case 'Newest first':return b.year-a.year;default:{const as=isShowroom(a),bs=isShowroom(b);if(as!==bs)return as?-1:1;return as?a.id-b.id:b.id-a.id}}});
 const showroomList=list.filter(isShowroom),japanList=list.filter(c=>!isShowroom(c));
 const cardsFor=items=>items.map(c=><VehicleCard key={c.id} c={c} onOpen={car=>{setSelected(car);setGalleryImage(null)}} comp={comp.includes(c.id)} onCmp={x=>{setComp(v=>v.includes(x.id)?v.filter(y=>y!==x.id):(v.length>=3?v:v.concat(x.id)))}}/>);
if(page==='inventory')return <section className="inner-page"><div className="page-hero mini"><div className="page-orb-wrap"><InteractiveGlobe lite cls="mini" onTap={()=>navigate('world')}/></div><div className="shell"><div className="kicker">LIVE JAPAN STOCK</div><h1>Find your next <em>vehicle.</em></h1><p>{list.length} verified vehicles · filters like BE FORWARD, styled for AR7.</p></div></div><div className="shell page-content"><div className="inv-toolbar"><label className="inv-search"><Search/><input value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search make, model or stock no."/></label><select value={make} onChange={e=>setMake(e.target.value)}><option>All</option>{makes.map(m=><option key={m}>{m}</option>)}</select><select value={fuel} onChange={e=>setFuel(e.target.value)}><option>All</option><option>Petrol</option><option>Hybrid</option><option>Diesel</option></select><select value={priceF} onChange={e=>setPriceF(e.target.value)}><option>Any</option><option>Under $15k</option><option>$15k–$30k</option><option>$30k+</option></select><select value={sortF} onChange={e=>setSortF(e.target.value)}><option>Featured</option><option>Price: low to high</option><option>Price: high to low</option><option>Mileage: low to high</option><option>Newest first</option></select></div><div className="logo-strip">{BRANDS().map(b=><button key={b.name} onClick={()=>{pendingMake=b.name;navigate('inventory')}}><img loading="lazy" decoding="async" width="44" height="26" src={LOGO(b.name)} alt={b.name+" logo"}/><span>{b.name}</span></button>)}</div><div className="inv-chips"><div>{['All','Showroom','Japan Stock','Luxury','Supercar','Hypercar','SUV','MPV','Sedan','Hatchback','Kei','Van'].map(x=><button key={x} onClick={()=>setBody(x)} className={body===x?'active':''}>{x}</button>)}</div>{comp.length>0&&<button className="cmp-open" onClick={()=>setShowCmp(true)}><ArrowLeftRight/> Compare {comp.length}<small>clear</small></button>}</div><div className="results-line"><b>{list.length} vehicles</b><span>{showroomList.length} showroom · {japanList.length} Japan stock · updated daily</span></div>{body==='All'&&sortF==='Featured'?<div className="inventory-groups">{showroomList.length>0&&<section className="inventory-group showroom-group"><div className="inventory-group-head"><div><span>AR7 CURATED COLLECTION</span><h2>Showroom cars</h2></div><b>{showroomList.length} vehicles</b></div><div className="car-grid full-grid">{cardsFor(showroomList)}</div></section>}{japanList.length>0&&<section className="inventory-group japan-group"><div className="inventory-group-head"><div><span>VERIFIED AUCTION & STOCK</span><h2>Japan inventory</h2></div><b>{japanList.length} vehicles</b></div><div className="car-grid full-grid">{cardsFor(japanList)}</div></section>}</div>:<div className="car-grid full-grid">{cardsFor(list)}</div>}{list.length===0&&<div className="empty-state"><Search/><h3>No matches</h3><p>Try clearing the filters or ask our team to source it.</p><button className="primary" onClick={openAuction}>Request a search <ArrowRight/></button></div>}</div>{showCmp&&<div className="cmp-backdrop" onClick={()=>setShowCmp(false)}><div className="cmp-modal" onClick={e=>e.stopPropagation()}><div className="cmp-head"><div><div className="kicker">COMPARE</div><h2>{comp.length} vehicles side by side</h2></div><button onClick={()=>setShowCmp(false)}><X/></button></div><table><thead><tr><th></th>{comp.map(id=>{const c=cars.find(x=>x.id===id);return <th key={id}><img loading="lazy" decoding="async" src={c.image} alt={`${c.make} ${c.model} — Japanese import`}/><b>{c.make} {c.model}</b><button onClick={()=>setComp(v=>v.filter(y=>y!==id))}>Remove</button></th>})}</tr></thead><tbody>{[['Price',c=>c.price],['Year',c=>c.year],['Mileage',c=>c.km+' km'],['Fuel',c=>c.fuel],['Body',c=>c.body],['Transmission',c=>c.tr],['Drive',c=>c.drv],['Engine',c=>c.eng],['Seats',c=>c.seats],['Grade',c=>c.grade],['Steering',c=>c.st],['Status',c=>c.status]].map(r=><tr key={r[0]}><th>{r[0]}</th>{comp.map(id=><td key={id}>{r[1](cars.find(x=>x.id===id))}</td>)}</tr>)}</tbody></table><div className="cmp-cta"><button className="primary" onClick={openAuction}>Request quote for best match <ArrowRight/></button></div></div></div>}</section>;
 const pages={
...
function App(){
 ...
 const navigate=(p)=>{location.hash=p;setPage(p);setMenu(false);scrollTo({top:0,behavior:'smooth'})};
 ...
 return <div className="site">
  <div className="grain"/><header className="nav-wrap"><nav className="nav shell">
   <div className="brand-group">
    <button className="brand" onClick={()=>navigate('home')} aria-label="AR7 home"><img src="/assets/ar7-mark.png" alt="AR7 Traders"/><span><b>AR7</b> <strong>TRADERS</strong><small>GLOBAL VEHICLE EXPORTERS</small></span></button>
   ...
   <div className={'navlinks '+(menu?'open':'')}>
    <button onClick={()=>navigate('inventory')}>Inventory</button><button onClick={()=>navigate('brands')}>Brands</button><button onClick={()=>navigate('auction')}>Auction access</button><button onClick={()=>navigate('tools')}>Calculators</button>
    <div className="nav-more">
     ...
     <div className="more-panel">
      ...
      ].map(x=>{const I=x[0];return <button key={x[2]} onClick={()=>navigate(x[2])}><i><I/></i><span>{x[1]}</span></button>})}
     </div>
    </div>
  ...
  <main>
   ...
   <section className="inventory shell section" id="inventory">
    ...
    <div className="car-grid">{shown.map((c,i)=><article className="car-card" key={c.id} style={{'--delay':i*80+'ms'}}>
      ...
      <div className="car-info"><div className="make"><img loading="lazy" decoding="async" width="34" height="22" src={LOGO(c.make)} alt=""/>{c.make}</div><h3>{c.model}</h3><div className="specs"><span><CalendarDays/> {c.year}</span><span><Gauge/> {c.km} km</span><span><Fuel/> {c.fuel}</span><span><ArrowLeftRight/> {c.tr}</span></div><div className="car-bottom"><div><small>EXPORT PRICE FROM</small><b>{c.price}</b></div><button onClick={()=>navigate('inventory')} aria-label="View vehicle"><ArrowUpRight/></button></div><div className="loc"><MapPin/> {c.location}, Japan</div></div>
    </article>)}</div>
    <button className="outline-btn" onClick={()=>navigate('inventory')}>View complete inventory <ArrowRight/></button>
   </section>
