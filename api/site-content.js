...
const allowed = {
  listings: ['stock_no','make','model','year','km','fuel','body','price','image','images','gallery','grade','status','location','tr','drv','eng','seats','col','st','published','sort_order','source','dealer_stock','pinned','goonet_id','photo_count','first_seen_at','last_seen_at','unavailable_since'],
